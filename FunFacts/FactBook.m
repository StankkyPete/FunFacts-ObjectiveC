...
-(instancetype)init {
    self = [super init];
    if (self) {
        _factBook = [NSArray arrayWithObjects:@"Ants stretch when they wake up.",
...
-(NSString *)randomFact {
    ...
    int random = arc4random_uniform((int)self.factBook.count);
    return [self.factBook objectAtIndex:random];
